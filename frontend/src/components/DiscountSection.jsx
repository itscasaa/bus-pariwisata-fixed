              ...
              <div className="p-5 flex flex-col flex-1">
                ...
                <div className="grid grid-cols-2 gap-2 mt-auto pt-4 border-t border-[#DDEAF6]">
                  ...
                  <a
                    ...
                    className="bg-[#0B655B] hover:bg-[#084D45] text-white font-bold text-[10px] py-2.5 rounded-xl text-center flex items-center justify-center gap-1 transition-all"
                  >
