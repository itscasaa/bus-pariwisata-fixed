...
<div class="max-w-xl">
  ...
  <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
    <h2 class="font-bold text-gray-800 text-lg mb-5">Form Tambah Harga</h2>
    ...
    <form method="POST" class="space-y-4">
      <div>
        ...
        <input type="text" name="nama_destinasi" value="<?= htmlspecialchars($_POST['nama_destinasi'] ?? '') ?>"
          placeholder="contoh: BANDUNG KOTA, LEMBANG"
      ...
      <div>
        ...
        <input type="text" name="durasi" value="<?= htmlspecialchars($_POST['durasi'] ?? '') ?>"
          placeholder="contoh: 12 Jam / 2 Hari"
          class="w-full px-4 py-2.5 border border-gray-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-[#1d6ec5]" required>
      </div>
      ...
      <div class="grid grid-cols-2 gap-4">
        <div>
          ...
          <input type="number" name="harga_hiace" value="<?= $_POST['harga_hiace'] ?? 0 ?>"
        ...
        <div>
          ...
          <input type="number" name="harga_elf" value="<?= $_POST['harga_elf'] ?? 0 ?>"
            class="w-full px-4 py-2.5 border border-gray-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-[#1d6ec5]">
        </div>
        <div>
          <label class="block text-sm font-semibold text-gray-700 mb-1.5">Harga Medium Bus (Rp)</label>
          <input type="number" name="harga_medium" value="<?= $_POST['harga_medium'] ?? 0 ?>"
            class="w-full px-4 py-2.5 border border-gray-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-[#1d6ec5]">
        </div>
        <div>
          <label class="block text-sm font-semibold text-gray-700 mb-1.5">Harga Big Bus (Rp)</label>
          <input type="number" name="harga_big" value="<?= $_POST['harga_big'] ?? 0 ?>"
            class="w-full px-4 py-2.5 border border-gray-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-[#1d6ec5]">
        </div>
      </div>
