...
- Name: vibechecker.spec.js >> Navigation >> Navigation Links Render
- Location: vibechecker\tests\vibechecker.spec.js:54:3
...
Locator: locator('nav, header, [role="navigation"]').first()
Expected: visible
Timeout: 8000ms
...
Call log:
  ...
  - waiting for locator('nav, header, [role="navigation"]').first()
